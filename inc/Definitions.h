...
// public:
//     int size(){return num;}
//     // void push(CostVector apex, CostVector cost, std::vector<int> waypoints){
//     //     all_apexes.push_back(apex);
//     //     all_costs.push_back(cost);
//     //     all_waypoints.push_back(waypoints);
//     //     num ++;
//     // }
//     void merge_new(CostVector apex, CostVector cost, std::vector<int> waypoints, double eps){
//         bool dominated = false;
//         for(int i = 0; i < num; i++){
//             if(is_dominated(apex, all_costs.at(i), eps)){
//                 dominated = true;
//                 all_apexes.at(i) = vector_min(all_apexes.at(i), apex);
//                 break;
//             }
//         }
//         if(!dominated){
//             for(int i = 0; i < num; ){
//                 if(is_dominated(all_apexes.at(i), cost, eps)){
//                     apex = vector_min(all_apexes.at(i), apex);
//                     all_apexes.erase(all_apexes.begin()+i);
//                     all_costs.erase(all_costs.begin()+i);
...
// private:
//     int num = 0;
//     std::vector<CostVector>     all_apexes;
//     std::vector<CostVector>     all_costs;
//     std::vector<std::vector<int>>   all_waypoints;
// };
